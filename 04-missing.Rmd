...
Firstly, we plotted a bar graph where x axis represents the column name and y axis represents the freqency of NA terms. It can be seen that majority of the columns don't have NA enries. And the highest number of NA entry in a column is close to 150.
```{r}
...
```
# function implementation to plot missing patterns
